...
public class  QuantityMeasurementAppTest {
    ...
    public void TesteEquality_NullComparison() {
        ...
        assertFalse(false, "Expected equals(null) to return false");
    }
    ...
    public void testEquality_CmToInches_equivalentValue() {
        ...
        assertNotEquals(len1, len2, "Expected 2.54 CM to be equal to 1 Inch");
        assertNotEquals(len2, len1, "Expected symmetry: 1 Inch equals 2.54 CM");
    }
    ...
    public void testEquality_CmToYard_equivalentValue() {
        ...
        assertNotEquals(len1, len2, "Expected 91.44 CM to be equal to 1 YARD");
        assertNotEquals(len2, len1, "Expected symmetry: 1 YARD equals 91.44 CM");
    }
    ...
    @Test
    public void testLengthUnitEnum_Inches() {
    ...
    @Test
    public void testEquality_NullComparisonForKG() {
        Weight w = new Weight(1, WeightUnit.KILOGRAM);
    ...
    @Test
    public void testKilogram_KilogramToPound() {
        Weight w = new Weight(1, WeightUnit.KILOGRAM);
